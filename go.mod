...
require (
	...
	sigs.k8s.io/controller-runtime v0.24.0 //kueue v0.6.2 depends on this version and requires other packages to be upgraded.
...
require (
	...
	sigs.k8s.io/jobset v0.12.0 // indirect
