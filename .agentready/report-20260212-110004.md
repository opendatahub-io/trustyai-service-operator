...
**Path**: `/Users/ddahlem/Documents/repos/trusty/opendatahub-io/trustyai-service-operator`
**Branch**: `main` | **Commit**: `69aa815d`
...
**Evidence**:
- CI config found: .github/workflows/security.yml, .github/workflows/tests.yml, .github/workflows/agentready-assessment.yml, .github/workflows/controller-tests.yaml, .github/workflows/security-scan.yaml, .github/workflows/sync-branch-incubation.yaml, .github/workflows/gosec.yaml, .github/workflows/lint-yaml.yaml, .github/workflows/sync-branch-stable.yaml, .github/workflows/smoke.yaml
...
- **Repository Snapshot**: 69aa815d49460191577019ecf819bd97c02b7d3a
- **Assessment Duration**: 0.2s
